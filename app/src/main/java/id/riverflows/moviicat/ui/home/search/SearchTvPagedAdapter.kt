...
class SearchTvPagedAdapter: PagingDataAdapter<TvEntity, SearchTvPagedAdapter.TvViewHolder>(
    TvComparator
) {
    ...
    inner class TvViewHolder(private val binding: ItemSearchListBinding) : RecyclerView.ViewHolder(binding.root){
